 ...
 * ----------------
 * Intentos: 
 * - Comunicacion con formato de Actividad a realizar:
 ...
 * - (DONE en V4) Correccion ciertos errores de la V3, en la reanudacion de actividad (timer seguia contando y alamaON)
