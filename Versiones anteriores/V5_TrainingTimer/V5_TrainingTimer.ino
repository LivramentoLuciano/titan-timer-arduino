...
void loop() {
  ...
  if (instanciaRutina == TRABAJO){
    if (pasoSegundo){
      pasoSegundo = 0;
      Serial.println("Set: " + String(sets) + " - Round: " + String(rounds)+ " - Tiempo Actividad: " + String(duracionActividad - segundos));  
      cleanDisplay7(0);
      cuentaDisplay(duracionActividad - segundos);   
  ...
  if (instanciaRutina == DESCANSO){
    if (pasoSegundo){
      pasoSegundo = 0;
      Serial.println("Set: " + String(sets) + " - Round: " + String(rounds)+ " - Tiempo Descanso: " + String(duracionDescanso - segundos)); 
      cleanDisplay7(0);
