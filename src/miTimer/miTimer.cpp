...
void secondsUpTimer(int dS)
{
  ...
  TCNT1 = 0;            // Inicializa el contador del Timer en 0 (durara 1 segundo entero al avanzar/retroceder)
  newSecond = true;     // Soluciona que no estoy accendiendo a 'routine.t' desde aca (en main lo actualizara)
}
